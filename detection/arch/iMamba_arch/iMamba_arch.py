...
class iMambaAnomalyDetector(nn.Module):
    """
    ...
    def __init__(self, seq_len, d_model, dropout, d_state=16, d_conv=4, expand=2, e_layers=2, use_norm=True):
        super(iMambaAnomalyDetector, self).__init__()
    ...
    def detect(self, x_enc):
        ...
        # --- GLOBAL AGGREGATION ---
        # Pool across the Variate dimension (N)
        ...
        logits = self.detector(global_representation) 
        return logits

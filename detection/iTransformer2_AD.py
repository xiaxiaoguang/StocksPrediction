...
from .arch import iTransformer2AnomalyDetector
...
CFG = EasyDict()
CFG.TRAIN = EasyDict()
CFG.NOTE = {"Anomaly Detection new datasets2"}

CFG.TEST_ONLY = False
# CFG.TEST_ONLY = True
# CFG.TRAIN.CKPT_SAVE_DIR = "/home/benyan2023/workspace/STEP/STEP/checkpoints/iTransformer2AnomalyDetector_100/"
# CFG.MD5 = "9dc5dc5dff14c072a8b89c4974428f40"

# ================= general ================= #
CFG.DESCRIPTION = "iTransformer2 (AD) configuration"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "iTransformer2AnomalyDetector"
CFG.MODEL.ARCH = iTransformer2AnomalyDetector
CFG.MODEL.PARAM = {
    "seq_len":SEQ_LEN ,
    "d_model":EMBED_DIM,
    "dropout":0.5,

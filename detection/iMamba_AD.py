...
from .arch import iMambaAnomalyDetector
...
CFG.TEST_ONLY = False
# CFG.TEST_ONLY = True
# CFG.TRAIN.CKPT_SAVE_DIR = "/home/benyan2023/workspace/STEP/STEP/checkpoints/iMambaAnomalyDetector_100/"
# CFG.MD5 = "latest/"
# ================= general ================= #
CFG.DESCRIPTION = "iMamba (AD) configuration"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "iMambaAnomalyDetector"
CFG.MODEL.ARCH = iMambaAnomalyDetector
CFG.MODEL.PARAM = {
    "seq_len":SEQ_LEN ,
    "d_model":EMBED_DIM,
    "dropout":0.5,

...
from basicts.archs.arch_zoo.astgcn_arch import ASTGCN
from basicts.runners.runner_zoo.astgcn_runner import ASTGCNrunner
...
CFG.StartTest.ckpt_save_dir = "benchmark/ASTGCN_100/4f7238a620aa3f2bacbdc3ac5bd28a5b"
ALL_BATCH = 1


# ================= general ================= #
CFG.DESCRIPTION = "ASTGCN(StockD) configuration"
CFG.RUNNER = ASTGCNrunner
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "ASTGCN"
CFG.MODEL.ARCH = ASTGCN
...
CFG.MODEL.PARAM = {
    ...
    "nb_time_filter": 96, 
    "time_strides": 1,
    "adj_mx": np.random.randn(500,500), 
    "num_for_predict": 12,
    "len_input": 144,
    "num_of_vertices": 500
}

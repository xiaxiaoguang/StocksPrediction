...
class Mask(nn.Module):
    ...
    def __init__(self, patch_size, in_channel, embed_dim, 
                 ...
                 spatial=False, mode="pre-train",num_feats=1):
        super().__init__()
        ...
        # encoder specifics
        # # patchify & embedding
        self.patch_embedding = PatchEmbedding(patch_size, in_channel, embed_dim, norm_layer=None,num_feats=num_feats)
        # # positional encoding
    ...
    def decoding(self, hidden_states_unmasked, masked_token_index):
        ...
        if self.spatial:
            ...
            # I don't know why I didn't keep the original position of the masked tokens!
            # I guess is the positional encoding play the role !

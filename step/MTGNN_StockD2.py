...
from basicts.archs.arch_zoo.mtgnn_arch import MTGNN
from basicts.runners.runner_zoo.mtgnn_runner import MTGNNRunner
...
CFG.StartTest.ckpt_save_dir = "benchmark/MTGNN_100/2e94f04717a573a38498e5a50872806c"
ALL_BATCH = 1

# ================= general ================= #
CFG.DESCRIPTION = "MTGNN(StockD) configuration"
...
CFG.TRAIN.CUSTOM.STEP_SIZE=10
CFG.TRAIN.CUSTOM.NUM_NODES=500

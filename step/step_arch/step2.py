...
from .graphwavenet import GraphWaveNet5
...
class STEP2(nn.Module):
    ...
    def __init__(self, dataset_name, pre_trained_tsformer_path, 
        ...
        self.tsformer = SimpleFormer(**tsformer_args)
        self.backend = GraphWaveNet3(**backend_args)
        self.load_pre_trained_model()
        self.discrete_graph_learning = DiscreteGraphLearning4(**dgl_args)

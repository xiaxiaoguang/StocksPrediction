...
class DiscreteGraphLearning(nn.Module):
    ...
    def __init__(self, dataset_name, k , input_seq_len,num_nodes,
                 output_seq_len, pls=5 , move_window=5, embedding_dim=32):
        super().__init__()
        self.pls=pls
        ...
        self.train_length = {"METR-LA": 23990, "PEMS04": 13599, "PEMS03": 15303, "PEMS07": 16513,\
                              "PEMS-BAY": 36482, "PEMS08": 14284,"StockD":3617,"StockDEBUG":3617,"Crypto":1300}[dataset_name]
        ...
        self.dim_fc = {"METR-LA": 383552, "PEMS04": 217296, "PEMS03": 244560, "PEMS07": 263920,\
                        "PEMS-BAY": 583424, "PEMS08": 228256,"StockD":57584,"StockDEBUG":57584,"Crypto":20608}[dataset_name]
    ...
    def forward(self, long_term_history, tsformer):
        ...
        return bernoulli_unnorm, hidden_states[:,:,-1,:], adj_knn, sampled_adj

...
from basicts.archs import mamba3
from basicts.runners import Mamba3Runner
from step.step_loss import mamba_loss2
...
CFG.RUNNER = Mamba3Runner
CFG.DATASET_CLS = TimeSeriesForecastingDataset
CFG.DATASET_NAME = "METR-LA"
CFG.DATASET_TYPE = "METR-LA data"

CFG.ContrastiveLoss = True
CFG.StrongNoise = False
CFG.RepeatTimes = 3
CFG.RepeatNoise = 1 # MENTION , weak_noise is open

...
CFG.StartTest.ckpt_save_dir = "checkpoints/STEP3_70/85a133c77d8dd65066bc5b1261aadbb1" # 选择哪个模型测试
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "STEP3"
CFG.MODEL.ARCH = STEP3
CFG.MODEL.PARAM = {

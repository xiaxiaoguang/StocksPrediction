...
class STEP4Runner(BaseTimeSeriesForecastingRunner):
    def __init__(self, cfg: dict):
        ...
        self.metrics = cfg.get("METRICS", {"MAE": masked_mae, "RMSE": masked_rmse, "MAPE": masked_mape , 
                                           ...
                                           "Random_Return_30":RndReturn(30),"Success_rate_30":successK(30),
                                           "Best_Return_90":bstReturn(90),"Our_Return_90":predReturn(90),
                                           "Random_Return_90":RndReturn(90),"Success_rate_90":successK(90)
                                           })
    ...
    def forward(self, data: tuple, epoch:int = None, iter_num: int = None, train:bool = True, **kwargs) -> tuple:
        ...
        return prediction, real_value, _, _, _, epoch

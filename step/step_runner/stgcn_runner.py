...
class STGCNRunner(BaseTimeSeriesForecastingRunner):
    ...
    def forward(self, data: tuple, epoch:int = None, iter_num: int = None, **kwargs) -> tuple:
        ...
        # feed forward
        prediction = self.model(history_data=long_history_data, future_data=None, batch_seen=iter_num, epoch=epoch)

...
from .step_arch import STEP4
from .step_runner import STEP4Runner
from .step_loss import step4_loss
...
CFG.StartTest.ckpt_save_dir = "checkpoints/STEP4_70/442278dc177e6a7f1405c3bef935047e" # 选择哪个模型测试
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "STEP4"
CFG.MODEL.ARCH = STEP4
CFG.MODEL.PARAM = {
    "dataset_name": CFG.DATASET_NAME,
    "pre_trained_tsformer_path": "checkpoints/CAOFormer_90/b44d30dc5ecbcd92a46e42483dd84eac/CAOFormer_90.pt",
    "tsformer_args": {
        "patch_size":16,
        "in_channel":1,
        "embed_dim":EMBED_DIM,

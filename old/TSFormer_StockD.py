...
from SMTSF import SMTSF
from SMTSF import SMTSFRunner
from .step_data import PretrainingDataset
from .step_loss import smtsf_loss
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "SMTSF"
CFG.MODEL.ARCH = SMTSF
...
CFG.MODEL.PARAM = {
    ...
    "mlp_ratio":4,
    "dropout":0.5,
    "num_token":INPUT_LEN//(5*4), #我吐了啊啊啊啊啊
    "mask_ratio":0.8,
    "week_encoder_depth":2,
    "month_decoder_depth":1,
    "space_decoder_depth":1,
    "final_decoder_depth":1,

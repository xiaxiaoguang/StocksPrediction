...
from MSCFormer2 import MSCFormer
from MSCFormer import MSCFormerRunner
from .step_data import PretrainingDataset
from .step_loss import tsformer_loss
...
CFG.NOTE = "修改数据集之后 选择了那些总是活着有交易量的老牌股票"

# ================= general ================= #
CFG.DESCRIPTION = "TSFormer(StockD) configuration"
CFG.RUNNER = MSCFormerRunner
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "MSCFormer"
CFG.MODEL.ARCH = MSCFormer

CFG.MODEL.PARAM = {
    "patch" : [5,4,3],
    "sample_channel":[2,2,2],
    "embed_dim":96,
    "num_heads":4,
    "mlp_ratio":4,
    "dropout":0.5,
    "num_feats":45,
    "num_tokens":INPUT_LEN, #我吐了啊啊啊啊啊
    "mask_ratio":0.8, # high level masked!
    "num_decoder": 3,
    "decoder_depth" : 1,
...
CFG.TRAIN.LR_SCHEDULER.PARAM= {
    "milestones":[5,10,15,20,25,35,45,55,65,75,85],
    "gamma":0.5
}
# ================= train ================= #

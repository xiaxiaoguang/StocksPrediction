...
CFG.MODEL.PARAM = {
    ...
    "pre_trained_tsformer_path": "checkpoints/MSCFormer_104/72c6c4b0e452fb8da70671effb7f4cb9/MSCFormer_best_val_MAE.pt",
    "tsformer_args": {
            "patch" : [5,4,4],
            "in_channel":1,
            "embed_dim":EMBED_DIM,

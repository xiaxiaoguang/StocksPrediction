...
CFG.StartTest.ckpt_save_dir = "checkpoints/STEP2_70/b0339c02c5fe562988a2dc52e81e8345" # 选择哪个模型测试
CFG.StartTest.test_whole = True # 是否进行预测累计收益率的测试
CFG.StartTest.UseTrain = False  # 是否使用训练集进行测试
CFG.StartTest.UseValid = True # 是否使用验证集测试
CFG.StartTest.test_line = True # 是否进行绘制某只股票的价格曲线的测试
CFG.StartTest.select = 3 # 选择哪只股票？
...
CFG.MODEL.PARAM = {
    ...
    "pre_trained_tsformer_path": "checkpoints/CAOFormer_90/b44d30dc5ecbcd92a46e42483dd84eac/CAOFormer_best_val_MAE.pt",
    "tsformer_args": {
        "patch_size":16,
        "in_channel":1,
        "embed_dim":EMBED_DIM,

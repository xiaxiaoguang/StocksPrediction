...
from SATFormer2 import SATFormer
from SATFormer2 import MSCFormerRunner
...
CFG.NOTE = "选择进行多种长度的decoder解码 公用decoder和encoder实现更好的泛化性"
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = "SATFormer"
CFG.MODEL.ARCH = SATFormer

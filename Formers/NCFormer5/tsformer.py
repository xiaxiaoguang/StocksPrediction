...
class NCFormer(nn.Module):
    ...
    def __init__(self, patch_size,node_fusion, 
        ...
        self.input_Linear = nn.Linear(num_feats,1)     
    ...
    def encoding(self, long_term_history, mask=True):
        ...
        ent1 = self.input_Linear(long_term_history.reshape(batch_size,num_nodes,tim_len,-1)).squeeze(-1)
